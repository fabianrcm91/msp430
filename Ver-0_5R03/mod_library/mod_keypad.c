...
char keypadLineGetc(void){
	...
	if (var==BIT0) {
        ...
        var = 'I';
    }else if (var==(BIT1 + BIT3)) {
        var = '1';
    }else if (var==(BIT1 + BIT2)) {
        var = '2';
    }else if (var==(BIT1 + BIT0)) {
        var = '3';
    }else if (var==(BIT3 + BIT2)) {
        var = '4';
    }else if (var==(BIT3 + BIT0)) {
        var = '0';
    }

	pinDisPullUp(keypad_row1);;
